...
public class QPayInfo extends EntityPathBase<PayInfo> {
    ...
    private static final long serialVersionUID = -1656372904L;
    ...
    public QPayInfo(Class<? extends PayInfo> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new com.project1.domain.shopping.order.entity.QOrder(forProperty("order"), inits.get("order")) : null;
    }
